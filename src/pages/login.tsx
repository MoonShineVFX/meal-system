...
export default function PageLogin() {
  ...
  return (
    <div className='fixed inset-0 flex'>
      <Title prefix='登入' />
      <div className='flex w-full shrink-0 flex-col justify-center bg-gray-50 md:max-w-md'>
        <form
        ...
        >
          ...
          <h1 className='text-xl font-bold tracking-wider text-gray-600'>
            請登入夢想 AD 帳號
          </h1>
          <InputField
            disabled={isBusy}
  ...
  return (
    <div className='flex flex-col gap-1'>
      ...
      <input
        ...
        autoCapitalize='none'
        autoCorrect='off'
        className='rounded-2xl border-[1px] border-gray-300 bg-gray-100 py-2 px-4 text-lg font-bold focus:outline-violet-500 disabled:opacity-75'
      />
    </div>
  )
}
